...
const Barra_Obj = (props) => {
    ...
    const listaDeObjetos = [
      { obj: Obj_6, titulo: "Fragmento 6", descripcion: "Descripción 1" },
      { obj: RM01, titulo: "RM01", descripcion: "Descripción 2" },
      { obj: DAA01, titulo: "DAA01", descripcion: "Descripción 3" },
      { obj: ABR02, titulo: "ABR02", descripcion: "Descripción 4" },
      { obj: ERB02, titulo: "ERB02", descripcion: "Descripción 5" },
      { obj: ERB03, titulo: "ERB03", descripcion: "Descripción 6" },
      { obj: ESS01, titulo: "ESS01", descripcion: "Descripción 7" },
      { obj: MAA01, titulo: "MAA01", descripcion: "Descripción 8" },
    ];
  
    // Función para dividir la lista en grupos de 3
      ...
      <div className='Barra_Obj'>
        ...
        <div className='obj-container'>
          {gruposDeObjetos[currentPage - 1].map((obj, index) => (
            <Obj key={index} obj={obj.obj} titulo={obj.titulo} descripcion={obj.descripcion} />
          ))}
        </div>
